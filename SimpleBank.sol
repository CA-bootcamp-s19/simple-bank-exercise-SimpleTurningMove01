...
// Jim DeSoucey SimpleBank.sol 01/25/2020
...
contract SimpleBank {
    ...
    function() external payable {
        revert("Thanks for the help Mustafa");
    }
	...
	function deposit() payable public returns (uint) {
		...
		"You cannot deposit without becoming a member");
    ...
    function withdraw(uint withdrawAmount) public returns (uint) {
		...
		require(enrolled[msg.sender] == true, "You are not a member"); 
